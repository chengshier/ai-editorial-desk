...
export const capabilityLabel:Record<string,string>={search:'搜索采集',account:'账号采集',detail:'详情采集',comments:'评论采集',feed:'订阅采集',hotlist:'热榜采集',manual_import:'手工导入'}
...
export const sourceModeLabel:Record<string,string>={feed:'订阅采集',search:'搜索采集',account:'账号采集',detail:'详情采集',comments:'评论采集',hotlist:'热榜采集',manual_import:'手工导入'}
