...
export type EditorialDecision='adopt'|'watch'|'drop'|'archive'
...
export interface EventQuery{page:number;pageSize:number;status?:EventStatus;category?:string;includeMerged?:boolean;risk?:EditorialRisk;hasEvidence?:boolean;hasScore?:boolean;hasDraft?:boolean;decision?:EditorialDecision;updatedFrom?:string;updatedTo?:string;q?:string;sortBy?:'last_updated_at'|'first_seen_at'|'traffic_total';sortDirection?:'asc'|'desc'}
