...
import type { EditorialRisk,EventQuery,EventStatus,WorkbenchEventPage } from '../workbenchTypes'
...
export function EditorialEventsPage({api,onOpenEvent}:{api:WorkbenchApi;onOpenEvent:(id:string)=>void}){
 ...
 return <Panel title="Event Explorer" actions={<button onClick={()=>void load()}>Refresh</button>}>
  <div className="notice">Event lifecycle is not an editorial decision. Sorting by Effective Score is ordinary exploration, not candidate ranking.</div>
