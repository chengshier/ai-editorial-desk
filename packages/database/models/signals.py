...
class Source(UUIDPrimaryKeyMixin, TimestampMixin, Base):
    ...
    __table_args__ = (
        ...
        Index("ix_sources_instance_enabled", "connector_instance_id", "enabled", "status"),
...
class RawSignalRecord(UUIDPrimaryKeyMixin, CreatedAtMixin, Base):
    ...
    __table_args__ = (
        UniqueConstraint("idempotency_key", name="uq_raw_signals_idempotency_key"),
    ...
    collected_at: Mapped[datetime] = mapped_column(
        UTCDateTime(), nullable=False, default=utc_now, server_default=sql_text("CURRENT_TIMESTAMP")
    )
...
class RawSignalCommentRecord(UUIDPrimaryKeyMixin, CreatedAtMixin, Base):
    ...
    __table_args__ = (
        UniqueConstraint("idempotency_key", name="uq_raw_signal_comments_idempotency_key"),
        CheckConstraint("char_length(idempotency_key) = 64", name="comment_idempotency_sha256"),
        CheckConstraint("like_count IS NULL OR like_count >= 0", name="comment_like_count_nonnegative"),
        Index("ix_raw_signal_comments_signal_published", "raw_signal_id", "published_at"),
        Index("ix_raw_signal_comments_platform_comment", "platform", "external_comment_id"),
    )
...
class CollectionBudget(UUIDPrimaryKeyMixin, TimestampMixin, Base):
    ...
    __table_args__ = (
        UniqueConstraint("scope_type", "scope_key", name="uq_collection_budgets_scope"),
        CheckConstraint("max_runs_per_day >= 1", name="max_runs_per_day_positive"),
        CheckConstraint("max_items_per_run >= 1", name="max_items_per_run_positive"),
        CheckConstraint("max_items_per_day >= 1", name="max_items_per_day_positive"),
        CheckConstraint("max_comments_per_run >= 0", name="max_comments_per_run_nonnegative"),
        CheckConstraint("max_comments_per_day >= 0", name="max_comments_per_day_nonnegative"),
    ...
    scope_key: Mapped[str] = mapped_column(String(500), nullable=False)
    max_runs_per_day: Mapped[int] = mapped_column(Integer, nullable=False, default=100, server_default=sql_text("100"))
    max_items_per_run: Mapped[int] = mapped_column(Integer, nullable=False, default=100, server_default=sql_text("100"))
    max_items_per_day: Mapped[int] = mapped_column(Integer, nullable=False, default=5000, server_default=sql_text("5000"))
    max_comments_per_run: Mapped[int] = mapped_column(Integer, nullable=False, default=0, server_default=sql_text("0"))
    max_comments_per_day: Mapped[int] = mapped_column(Integer, nullable=False, default=0, server_default=sql_text("0"))
    max_concurrency: Mapped[int] = mapped_column(Integer, nullable=False, default=1, server_default=sql_text("1"))
    timezone: Mapped[str] = mapped_column(String(64), nullable=False, default="Asia/Shanghai", server_default=sql_text("'Asia/Shanghai'"))
    enabled: Mapped[bool] = mapped_column(Boolean, nullable=False, default=True, server_default=sql_text("true"))
    updated_by: Mapped[str | None] = mapped_column(String(255))
...
class CollectionBudgetUsage(UUIDPrimaryKeyMixin, Base):
    ...
    __table_args__ = (
        UniqueConstraint("budget_id", "usage_date", name="uq_collection_budget_usage_day"),
        ...
        CheckConstraint("comments_reserved >= 0", name="comments_reserved_nonnegative"),
    ...
    budget_id: Mapped[UUID] = mapped_column(
        ForeignKey("collection_budgets.id", ondelete="CASCADE"), nullable=False, index=True
    )
    usage_date: Mapped[date] = mapped_column(Date, nullable=False)
    runs_reserved: Mapped[int] = mapped_column(Integer, nullable=False, default=0, server_default=sql_text("0"))
    runs_completed: Mapped[int] = mapped_column(Integer, nullable=False, default=0, server_default=sql_text("0"))
    items_reserved: Mapped[int] = mapped_column(Integer, nullable=False, default=0, server_default=sql_text("0"))
    items_used: Mapped[int] = mapped_column(Integer, nullable=False, default=0, server_default=sql_text("0"))
    comments_reserved: Mapped[int] = mapped_column(Integer, nullable=False, default=0, server_default=sql_text("0"))
    comments_used: Mapped[int] = mapped_column(Integer, nullable=False, default=0, server_default=sql_text("0"))
    active_runs: Mapped[int] = mapped_column(Integer, nullable=False, default=0, server_default=sql_text("0"))
    version: Mapped[int] = mapped_column(Integer, nullable=False, default=1, server_default=sql_text("1"))
    updated_at: Mapped[datetime] = mapped_column(
        UTCDateTime(), nullable=False, default=utc_now, server_default=sql_text("CURRENT_TIMESTAMP"), onupdate=utc_now
    )
